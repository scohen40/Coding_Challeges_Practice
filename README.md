...
- [ ] **[Movies Dataset Prompts](Movies_Datasets_Prompts)**: sql, BFS, and DFS, edge list, each prompt solution builds on the one before it
    * [x] **[Prompt 1 - Read and Parse a Large CSV](Movies_Datasets_Prompts/Movies_Dataset_Prompt_1.py)**: load CSV data then execute queries to attatch actors to their movies
